...
<style>
	...
	.leftNav-title-box .el-menu-item{
		background-color: #042950;font-size: 12px;
	}
	.leftNav-title-box .el-menu-item:hover{
		background-color: #0a417a;
	}
	.leftNav-title-box .el-icon-location,.leftNav-title-box .el-submenu__icon-arrow,.leftNav-title-box .el-icon-arrow-down {
		color: #FFF;
	}
	.wrap-left .el-menu{border-right:none}
</style>